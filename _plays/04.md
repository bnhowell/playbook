...
2. Run usability tests frequently to see how well the service works and identify improvements that should be made; share results summary and debrief activities with the project team (Show the project team examples of user behavior)
...
5. Release features and improvements multiple times each month; communicate new features to project team and users as appropriate
...
- What are the key user/usability/accessibility research, UX/UI design, and development objectives for each iteraction/sprint?
